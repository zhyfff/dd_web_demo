...
<body>
	...
	<div class="hui-wrap" >
			<form  style="padding:28px 10px;" id = "apply_link_form" action="Feedback/newfeed" method="post" name="apply_link_form" class="hui-form">
				<c:forEach items="${userinfoList}" var="u">
						...
						<div class="hui-form-items">
							<div class="hui-form-items-title">提交人员姓名:</div>
							 <input type ="text" id ="complaint_people" class="hui-input" name="complaint_people" value="${u.name}" readonly="readonly">
						</div>
				...
				<div class="borrowde1_">
					...
					<input type ="hidden" id ="borrowde1_2" name="borrowde1_2" value="${d.zid}" readonly="readonly">
						...
						<div class="hui-form-items">
							<div class="hui-form-items-title">投诉或意见内容</div>
							<input type = "text" id ="complaint_content" class="hui-input" name ="complaint_content" checkType="string" checkData="1,50" checkMsg="事由应为1-50个字符" required="required">
						</div>
						...
						<div class="hui-form-items">
							...
							<input type="hidden" id="link_spid"  name ="link_spid" readonly="readonly">
						 		...
						 		<div class="hui-form-radios">
										<input type="radio" id="success" name="anonymous" value="匿名" style="margin-left:40px; margin-top: 10px"><label for="success" >匿名</label>
										<input type="radio" id="fail" name="anonymous" value="非匿名" style="margin-right:40px; margin-top: 10px"> <label for="fail">实名</label>
									</div>
