...
<!-- 						<img src="${basePath}dingdingweb/HUI/img/list/sc.png"> -->
<!-- 					</div> -->
...
<!-- 	</div> -->
<!-- 	<div id="footer-logo"> -->
<!-- 		<img src="${basePath}dingdingweb/HUI/img/footer-logo2.png" /> -->
<!-- 	</div> -->
...
<script type="text/javascript">
		function newAddtInfo() {
			...
			window.location ='${basePath}Contract/tonewadd.do?info='+encodeURIComponent(info);
		}
		function newSelelectInfo(){
			var info = Encrypt($("#info").attr("value"));
			window.location ='${basePath}Contract/tonewselect.do?info='+encodeURIComponent(info);
		}
</script>
