...
<%-- <script type="text/javascript" src="${basePath}dingdingweb/HUI/office/Stamp_Certificate/js/stamp_certificate.js"></script> --%>
<script type="text/javascript">
$(document).ready(function(){
	...
	function loadScript(){
		if (os.isAndroid || os.isPhone) {
			...
			script.type="text/javascript";
			script.src="dingdingweb/HUI/office/Stamp_Certificate/js/stamp_certificate.js";
			document.getElementsByTagName('head')[0].appendChild(script); 
		// 	script.onload=function(){}//js加载完成执行方法
		}else {
			var script=document.createElement("script");
			script.type="text/javascript";
			script.src="dingdingweb/HUI/office/Stamp_Certificate/js/stamp_certificate_pc.js";
			document.getElementsByTagName('head')[0].appendChild(script); 
...
<body>
	...
	function registered() {
		...
		if (myCheck()==true) {
			$.ajax({
				url : "${basePath}Office/StampCertificate/saveApplyStamp",
