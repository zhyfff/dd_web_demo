...
function nextPage(){
	...
	$.ajax({
		url:'${basePath}Office/StampCertificate/searchStampApplyInfor?searchkey='+kwd+'&pageNum='+page,
		type:'get',
		dataType:'text',
...
function searchNow(){
	...
	$.ajax({
		url:'${basePath}Office/StampCertificate/searchStampApplyInfor?searchkey='+kwd+'&pageNum=1',
		type:'GET',
		dataType:'text',
		success:function (result){
			hui.closeLoading();
