...
function ding(){
	...
	var nw = $("#nw").attr("value")+"，请到海鑫服务中心微应用查看\n"+
	"快递号："+$("input[name='express-no']").val()+"\n"+
	"收件人："+$("#recipients").attr("value")+"\n"+
	"快递公司："+$("#express").attr("value")+"\n"+
	"通知时间："+$("input[name='notice-time']").val();
//	alert(nw);
//	alert("usid："+usid);
	var uarry = new Array();
	uarry[0]=usid;
