...
//					alert("audit-name");
					$(target).parent().children("#audit-name").val(name);
...
//					alert("lq");
					 ...
					 $(target).parent().children("#lq").val(name);
					 $(target).parent().children("#lq-img").attr("src",avatar);
...
function ding(){
	...
	"公司名称："+$("select[name='company']").val()+"\n"+
	"公司网址："+$("select[name='web']").val()+"\n"+
	"申请数量:"+$("select[name='num']").val()+"\n";
