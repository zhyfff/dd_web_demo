...
// 		alert(info)
		if (info=="") {
			...
			window.location ='${basePath}Office/BusinessCard/sendapply?info='+encodeURIComponent(info)
		}
	}
...
// 		alert(info)
		if (info=="") {
			...
			window.location ='${basePath}Office/BusinessCard/searchapply?info='+encodeURIComponent(info)
		}
	}
