DingTalkPC.config({
		...
		jsApiList : ['biz.ding.post','biz.contact.choose']
	});
...
//	alert(usid);
	...
	"申请时间："+$("input[name='ptime']").val()+"\n"+
	"采购类型："+$("input[name='ptype']").val()+"\n"+
	"耗材分类："+$("input[name='consumable_type']").val()+"\n"+
	"申领耗材名称："+$("input[name='consumable_name']").val()+"\n"+
	"耗材单价："+$("input[name='consum_uprice']").val()+"\n"+
	"领用总价："+$("input[name='consum_tprice']").val()+"\n"+
	"申请数量："+$("input[name='consumable_num']").val();
