...
<script type="text/javascript">
		function newAddtInfo() {
			window.location ='${basePath}Repair/tonewRepair.do?info='+encodeURIComponent($("#info").attr("value"))
		}
		function newSelelectInfo(){
			window.location ='${basePath}Repair/toselect.do?info='+encodeURIComponent($("#info").attr("value"))
		}
