...
public interface OfficeService {
		...
		public List<CourierInfor> SelectCourierNotice(String searchkey);//查询快递提醒信息
		...
		public List<Car> updateCar(String state,String license_plate);//修改车辆状态
		public List<ApplyCarInfor> SaveApplyCar(ApplyCarInfor applyCarInfor);//提交车辆申请信息入库
		public List<ApplyCarInfor> selectApplyCar(String searchkey);//查询提交的车辆申请信息
		...
		public List<ApplyCarInfor> selectMyCar(String searchkey);//查询我借用的车辆；
		public List<ApplyCarInfor> sureBackApplyCar(String searchkey);//确认车辆借用归还
		...
		public List<ApplyStampInfor> selectNeedAdutistamp(String audit_name);//需要审核的印章证照申请
		public List<ApplyStampInfor> toManger(ApplyStampInfor applyStampInfor);//审核完成传给印章管理员
		public List<ApplyStampInfor> selectAuditedApplyStamp(String manager);//获取审核完成的印章借用信息
		...
		public List<ApplyStampInfor> selectMyStamp(String userName);//获取我的印章证照信息
		...
		public List<ApplyStampInfor> searchStampApplyI(String searchkey);//搜索印证申请
