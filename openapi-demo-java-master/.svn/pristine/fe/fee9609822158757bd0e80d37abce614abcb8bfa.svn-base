...
<body>
	...
	<script type="text/javascript">
		function senduserjsontofeedbacking() {
			window.location ='${basePath}Feedback/tofeedbacking.do?info='+encodeURIComponent($("#info").attr("value"))
		}
		function senduserjsontomydeal(){
			window.location ='${basePath}Feedback/toMydeal.do?info='+encodeURIComponent($("#info").attr("value"))
		}
		function senduserjsontonew() {
			window.location ='${basePath}Feedback/tonewSugestion.do?info='+encodeURIComponent($("#info").attr("value"))
		}
		function senduserjsontofind(){
			window.location ='${basePath}Feedback/toFind.do?info='+encodeURIComponent($("#info").attr("value"))
		}
