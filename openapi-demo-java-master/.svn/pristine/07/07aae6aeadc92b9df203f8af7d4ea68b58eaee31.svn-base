...
public class DepartmentHelper {
     ...
     */
    public static DepartmentDetail detailDepartments(String accessToken, String DeptId) throws ServiceException, ServiceNotExistException, SdkInitException{
    	 CorpDepartmentService corpDepartmentService = ServiceFactory.getInstance().getOpenService(CorpDepartmentService.class);
         DepartmentDetail deptdetail = corpDepartmentService.getDeptDetail(accessToken, DeptId);
		return deptdetail;
    }
