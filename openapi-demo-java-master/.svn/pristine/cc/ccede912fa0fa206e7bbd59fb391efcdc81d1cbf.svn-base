...
function getMycarInfor(){
	$.ajax({
		url:'Office/ApplyCar/getMyCarInfor?name='+$("#userName").text()+'&pageNum=1',
		type:'GET',
		dataType:'text',
		success:function(result){
			...
			for (var i = 0; i < blist.length; i++) {
				...
				'<div class="hui-accordion-title">'+car_name+'-'+audit_time+'</div>'+
				...
				'<form style="padding: 28px 10px;" id="mycar" name="mycar"'+
					...
					'</div>'+
							...
							'</div>'+
								...
								'<input type="submit" id="submit" value="归还"'+
...
function nextPage(){
	$.ajax({
		url:'Office/ApplyCar/getMyCarInfor?name='+$("#userName").text()+'&pageNum='+page,
		type:'get',
		dataType:'text',
		success:function(result){
			var re = JSON.parse(JSON.stringify(result));
...
<!-- 									<input type="text" id="audit-opinion" name="audit-opinion" -->
<!-- 										required="required" class="hui-input" -->
<%-- 										value="${a.audit_opinion}" readonly="readonly"> --%>
<!-- 								</div> -->

<!-- 								<div class="hui-form-items"> -->
<!-- 									<div class="hui-form-items-title">审批人</div> -->
<!-- 									<input type="text" id="audit-name" name="audit-name" -->
<%-- 										required="required" class="hui-input" value="${a.audit_name}" readonly="readonly"> --%>
<!-- 								</div> -->

<!-- 								<div class="hui-form-items"> -->
<!-- 									<div class="hui-form-items-title">审批时间</div> -->
<!-- 									<input type="text" id="audit-time" name="audit-time" -->
<%-- 										required="required" class="hui-input" value="${a.audit_time}" readonly="readonly"> --%>
<!-- 								</div> -->

<!-- 								<div class="hui-form-items"> -->
<!-- 									<div class="hui-form-items-title">备注</div> -->
<!-- 									<input type="text" id="note" name="note" class="hui-input" -->
<%-- 										required="required" value="${a.note}" readonly="readonly"> --%>
<!-- 								</div> -->
