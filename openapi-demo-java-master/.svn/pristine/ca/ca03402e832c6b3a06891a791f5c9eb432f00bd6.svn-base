...
<body>
	...
	<div class="searchform">
		...
		<form name="fs" action="${basePath}Repair/tofind" method="post" class="hui-header-sreach">
			<input name="searchname" type="search" placeholder="" class="span3">
		...
		<div class="hui-accordion-title">单 据 号:${s.dctid}-
			<c:choose>
					   <c:when test="${s.process_donetime eq null}">
						    ...
						    <c:when test="${s.repair_evaluation eq null&&s.process_donetime != null}">
						    		未反馈
						    </c:when>
						    <c:when test="${s.repair_evaluation != null&&s.end_time != null}">
						    		已完成
						    </c:when>
					...
					<li>
								...
								<li>
						     	...
						     	<li>
									<div class="hui-list-icons"><img src="${basePath}dingdingweb/HUI/img/index/number.png" /></div>
									<div class="hui-form-items">
									<div class="hui-form-items-title">处理时间</div>
									<input type="text" readonly="readonly"
								...
								<li>
								 ...
								 <li>
									...
									<input type="text" readonly="readonly"
											value="${s.repair_evaluation}"   class="hui-input">
											</div>
								</li>
									<li>
									<div class="hui-list-icons"><img src="${basePath}dingdingweb/HUI/img/index/number.png" /></div>
